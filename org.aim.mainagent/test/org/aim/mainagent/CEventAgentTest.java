...
//
//		final Field monitorEventListenerField = CEventAgentAdapter.class.getDeclaredField("initialized");
//		monitorEventListenerField.setAccessible(true);
//		monitorEventListenerField.setBoolean(null, true);
//
//		final Field activatedField = CEventAgentAdapter.class.getDeclaredField("activated");
...
//		final InstrumentationDescription desc = idBuilder.build();
//
...
//
//		final Method undoInstrumentation = EventInstrumentor.class.getDeclaredMethod("undoInstrumentation");
