 ...
 * 
 */
public class ConstructorScopeExtension extends AbstractInstApiScopeExtension {

	@Override
	public String getName() {
		return ConstructorScope.class.getName();
	}

	@SuppressWarnings("unchecked")
	@Override
	public <EA extends IExtensionArtifact> EA createExtensionArtifact(final String... patterns) {
		return (EA) new ConstructorScope(this,0,patterns);
	}
